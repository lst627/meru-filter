...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="A threshold to apply on a MERU x_time score (e.g., a value of 0.25 will only keep examples with x_time over 0.25)",
    )
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="a fraction of metadata to keep according to MERU x_time score (e.g., a value of 0.25 will keep the top 25 percent of examples in the pool by MERU x_time score)",
    )
